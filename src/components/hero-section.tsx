            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                <TextEffect
                  ...
                  speedSegment={0.3}
                  as="h1"
                  className="mt-6 text-balance text-4xl md:text-5xl lg:mt-10 xl:text-[5.0rem]"
                >
                  Create Stunning PowerPoint Presentations With Ease
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                  ...
                  delay={0.5}
                  as="p"
                  className="mx-auto mt-8 max-w-2xl text-balance text-sm sm:text-md "
                >
                  Presina AI: Instantly create professional PowerPoint
                  presentations with AI, premium templates, and seamless content
                  generation.
                </TextEffect>
